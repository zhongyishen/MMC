...
axis equal;
%% 最优路径图
plot3([points(1,1),points(394,1)],[points(1,2),points(394,2)],[points(1,3),points(394,3)],'r');hold on;
plot3([points(394,1),points(280,1)],[points(394,2),points(280,2)],[points(394,3),points(280,3)],'r');hold on;
plot3([points(280,1),points(522,1)],[points(280,2),points(522,2)],[points(280,3),points(522,3)],'r');hold on;
plot3([points(522,1),points(355,1)],[points(522,2),points(355,2)],[points(522,3),points(355,3)],'r');hold on;
plot3([points(355,1),points(295,1)],[points(355,2),points(295,2)],[points(355,3),points(295,3)],'r');hold on;
plot3([points(295,1),points(92,1)],[points(295,2),points(92,2)],[points(295,3),points(92,3)],'r');hold on;
plot3([points(92,1),points(608,1)],[points(92,2),points(608,2)],[points(92,3),points(608,3)],'r');hold on;
plot3([points(608,1),points(171,1)],[points(608,2),points(171,2)],[points(608,3),points(171,3)],'r');hold on;
plot3([points(171,1),points(279,1)],[points(171,2),points(279,2)],[points(171,3),points(279,3)],'r');hold on;
plot3([points(279,1),points(376,1)],[points(279,2),points(376,2)],[points(279,3),points(376,3)],'r');hold on;
plot3([points(376,1),points(316,1)],[points(376,2),points(316,2)],[points(376,3),points(316,3)],'r');hold on;
plot3([points(316,1),points(404,1)],[points(316,2),points(404,2)],[points(316,3),points(404,3)],'r');hold on;
plot3([points(404,1),points(595,1)],[points(404,2),points(595,2)],[points(404,3),points(595,3)],'r');hold on;
plot3([points(595,1),points(369,1)],[points(595,2),points(369,2)],[points(595,3),points(369,3)],'r');hold on;
plot3([points(369,1),points(19,1)],[points(369,2),points(19,2)],[points(369,3),points(19,3)],'r');hold on;
plot3([points(19,1),points(end,1)],[points(19,2),points(end,2)],[points(19,3),points(end,3)],'r');hold on;
